...
function buildFallback(): { categories: Category[]; products: Product[]; variants: ProductVariant[] } {
  ...
  // No color/size options in the bundled offline catalog — variants are
  // only loaded from Supabase once the backend is configured.
