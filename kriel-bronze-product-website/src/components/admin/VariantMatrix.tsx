    ...
    <div>
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-200">
        <table className="min-w-full border-collapse text-[12.5px]">
          <thead>
            <tr>
              <th className="bg-slate-50 px-3 py-2 text-left text-[10.5px] font-bold uppercase tracking-wide text-slate-400 whitespace-nowrap">
                Ngjyra \ Madhësia
              </th>
              {cols.map((s) => (
                  ...
                  return (
                    <td key={s || "std"} className="px-2 py-1.5">
                      <div className="relative">
                        <span className="absolute left-2 top-1/2 -translate-y-1/2 text-[11px] font-semibold text-slate-400">€</span>
                        <input
                          type="number"
                          min="0"
                          step="0.01"
