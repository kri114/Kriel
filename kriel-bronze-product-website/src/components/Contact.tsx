          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {[
              ...
              <Reveal key={c.k} delay={0.1 + i * 0.06}>
                <a
                  ...
                  rel="noreferrer"
                  className="group flex items-center gap-4 rounded-2xl border border-line bg-ink-2 px-5 py-4.5 py-4 transition-colors hover:border-bronze/45"
                >
            ...
            <Reveal delay={0.35}>
              <div className="flex gap-3">
                <a href="#" aria-label="Facebook" className="flex h-11 w-11 items-center justify-center rounded-xl border border-line text-ivory-2 hover:text-bronze hover:border-bronze/45 transition-colors">
                  <FbIcon />
                </a>
                <a href="#" aria-label="Instagram" className="flex h-11 w-11 items-center justify-center rounded-xl border border-line text-ivory-2 hover:text-bronze hover:border-bronze/45 transition-colors">
                  <IgIcon />
                </a>
              </div>
            </Reveal>
