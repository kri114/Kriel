      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <Reveal className="relative">
          <div className="relative overflow-hidden rounded-[26px] border border-line">
            ...
            <img src="/images/atelier.jpg" alt="Farkëtimi i bronzit" className="h-[380px] sm:h-[520px] w-full object-cover" />
            ...
            <div className="absolute bottom-5 left-5 right-5 rounded-2xl border border-bronze/25 bg-ink/70 backdrop-blur-md px-5 py-4">
              <p className="font-display italic text-[19px] leading-snug text-ivory">
                &ldquo;Zjarri që transformon metalin në kujtim.&rdquo;
              </p>
              <p className="mt-1.5 text-[10.5px] tracking-[0.26em] uppercase text-bronze">Punishtja KRIEL</p>
            </div>
          </div>
        ...
        <div>
          ...
          <Reveal delay={0.15}>
            <p className="mt-5 text-[15px] leading-relaxed text-ivory-2/85 font-light max-w-lg">
              Prej vitesh sjellim bronz të vërtetë me të njëjtën pasion: çdo vepër kalon
              nëpër duart e mjeshtrave — nga modelet e gdhendura te patina finale — për t&apos;i
              dhënë kujtimit një formë të përjetshme.
            </p>
          </Reveal>
