...
import { CATEGORIES, PRODUCTS, Product } from "../data/catalogue";
            ...
            {list.map((p, i) => (
              ...
              >
                <div className="relative aspect-[4/4.5] overflow-hidden bg-[#cfc8bb]">
                  ...
                  />
                  <span className="absolute left-3 top-3 rounded-full bg-ink/55 backdrop-blur-sm px-2.5 py-1 text-[9.5px] font-semibold tracking-[0.14em] text-ivory/90 uppercase border border-ivory/10">
                    {p.code.replace("COD. ", "")}
                  </span>
