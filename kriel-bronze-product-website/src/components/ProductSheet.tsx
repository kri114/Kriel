...
import { X, Phone, MessageCircle, ShoppingBag, Ruler, Layers, Tag, PenLine, Check } from "lucide-react";
...
export default function ProductSheet({
  ...
  const handleAdd = () => {
    if (!canAdd) return;
    addItem(p, { qty, customText: customText.trim() });
    setAdded(true);
      ...
      >
        ...
        <div className="overflow-y-auto no-scrollbar" style={{ maxHeight: "calc(92svh - 20px)" }}>
          <div className="relative mx-4 overflow-hidden rounded-2xl bg-[#cfc8bb]">
            ...
            <img src={p.image || "/images/categories/germa.jpg"} alt={p.name} className="w-full max-h-[42svh] object-cover object-center" />
          </div>
