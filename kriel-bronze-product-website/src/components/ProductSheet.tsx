...
import { X, Phone, MessageCircle, ShoppingBag, Ruler, Layers, Tag, PenLine, Check, Palette, Expand, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function ProductSheet({
  ...
  const currentVariant = hasVariants
    ...
    : undefined;
  const currentPrice = currentVariant?.price ?? p.price;
          ...
          <div className="px-5 pt-5 pb-7">
            ...
            <div className="mt-3.5 flex items-end justify-between rounded-2xl border border-line bg-ink-3/50 px-4 py-3.5">
              <div>
                ...
                <p className="mt-0.5 font-display text-[32px] font-bold leading-none text-bronze-grad">{fmtEUR(currentPrice)}</p>
              </div>
