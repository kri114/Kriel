...
import { Search, ArrowUpDown, PackageSearch, ChevronDown } from "lucide-react";
            ...
            <div className="flex gap-2 items-center">
              <div className="relative flex-1 min-w-0">
                ...
                <input
                  ...
                  className="w-full rounded-full border border-line bg-white py-2.5 pl-10 pr-4 text-[13.5px] text-slate-900 placeholder:text-slate-400 transition-colors"
                />
              </div>
              <div className="relative shrink-0">
                ...
                <select
                  ...
                  className="appearance-none rounded-full border border-line bg-white py-2.5 pl-8 pr-8 text-[12.5px] font-semibold text-slate-900"
                >
