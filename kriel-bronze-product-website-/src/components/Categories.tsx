    ...
    <section id="kategorite" className="relative py-20 sm:py-28 overflow-hidden">
          ...
          <div>
            ...
            <Reveal delay={0.14}>
              <p className="mt-4 max-w-xl text-[14.5px] leading-relaxed text-ivory-2/80 font-light">
                E gjithë gama jonë e organizuar sipas llojit — nga statujat monumentale
                te detajet më të vogla të bronzit.
              </p>
            </Reveal>
          </div>
      ...
      <Reveal delay={0.18}>
        ...
        >
          {categories.map((c, i) => (
            ...
            >
              <div className="relative h-[210px] sm:h-[240px] overflow-hidden bg-[#cfc8bb]">
                ...
                <img
                  src={c.image || "/images/categories/germa.jpg"}
                  alt={c.name}
                  loading="lazy"
              ...
              <div className="p-4.5 px-5 py-4">
                ...
                {c.description ? (
                  <p className="mt-1.5 text-[11.5px] leading-snug text-ivory-2/60 line-clamp-2">{c.description}</p>
                ) : null}
          ...
          {categories.length === 0 && (
            <p className="text-ivory-2/60 text-sm py-10">Ende nuk ka kategori. Shtojini nga paneli i administratorit.</p>
          )}
        </div>
      </Reveal>
    </section>
