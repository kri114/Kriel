...
import { fetchCategories, fetchProducts } from "@/lib/store";
...
export default function SiteLoader() {
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    Promise.all([fetchCategories(), fetchProducts({ onlyActive: true })])
  ...
  return (
    <>
      ...
      <Site categories={catalog.categories} products={catalog.products} />
    </>
  );
}
