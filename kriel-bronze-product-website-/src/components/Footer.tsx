        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="mt-4 max-w-xs text-[13px] leading-relaxed text-ivory-2/70 font-light">
              Krijime origjinale në bronz — statuja, kryqe, llampa dhe kompozime
              përkujtimore për familjen tuaj.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-4 text-[12.5px] leading-relaxed text-ivory-2/65 font-light">
              ...
              të disponueshmërisë, modele të tjera dhe porosi të personalizuara, na kontaktoni.
            </p>
          </div>
        </div>
        <div className="hairline mt-12" />
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-6">
          <p className="text-[11px] tracking-[0.14em] text-ivory-2/50 uppercase select-none">
