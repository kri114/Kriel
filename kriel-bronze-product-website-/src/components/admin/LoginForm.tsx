      ...
      <form onSubmit={submit} className="w-full max-w-sm rounded-3xl bg-white shadow-xl p-8 border border-slate-200">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-700">Hyrje e administratorit</p>
          </div>
        </div>
        <label className="block mb-3">
          <span className="mb-1 block text-[11px] font-semibold uppercase tracking-wide text-slate-700">Email</span>
          <input
            type="email"
        ...
        <label className="block mb-5">
          <span className="mb-1 block text-[11px] font-semibold uppercase tracking-wide text-slate-700">Fjalëkalimi</span>
          <input
            type="password"
