          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Labeled label="Emri i setit (opsional)">
                <input value={newDraft.setName} onChange={(e) => setNewDraft({ ...newDraft, setName: e.target.value })} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-[14px]" placeholder="p.sh. Set A" />
              </Labeled>
            </div>
            <div className="mt-4">
                  ...
                  {!isEditing ? (
                    ...
                    <div>
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <Labeled label="Emri i setit (opsional)">
                          <input value={draft?.setName ?? ""} onChange={(e) => setDrafts((d) => ({ ...d, [p.id]: { ...d[p.id], setName: e.target.value } }))} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-[14px]" />
                        </Labeled>
                      </div>
                      <div className="mt-4">
                        <Labeled label="Përshkrimi">
