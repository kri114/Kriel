...
export async function fetchProducts(options?: {
  ...
  let query = getSupabase()
    .from("products")
    .select(
      "id, category_id, name, code, price, dims, material, description, image, images, sizes, colors, variants, sale_pct, sort_order, featured, featured_order, customizable, active"
    )
    .order("sort_order", { ascending: true })
    .order("id", { ascending: true });
